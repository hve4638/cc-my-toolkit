---
name: lit-survey
description: 다중 소스(Zotero, Obsidian, 로컬 PDF, arXiv, Semantic Scholar) 통합 문헌 검색 및 분석. "find papers", "related work", "literature review", "문헌 조사" 등의 요청 또는 종합적인 참고문헌 베이스 구축이 필요할 때 사용.
...
> - `/lit-survey "topic" — sources: web, semantic-scholar` — also search Semantic Scholar for published venue papers (IEEE, ACM, etc.)
