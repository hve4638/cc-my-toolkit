...
description: "Autonomously improve a generated paper via Claude review through claude-review MCP → implement fixes → recompile, for 2 rounds. Use when user says \"논문 수정\", \"improve paper\", \"논문 다듬기 반복\", \"auto improve\", or wants to iteratively polish a generated paper."
---
