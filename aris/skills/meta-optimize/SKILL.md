---
name: meta-optimize
description: "Analyze ARIS usage logs and propose optimizations to SKILL.md files, reviewer prompts, and workflow defaults. Outer-loop harness optimization inspired by Meta-Harness (Lee et al., 2026). Use when user says \"스킬 최적화\", \"meta optimize\", \"improve skills\", \"사용 기록 분석\", or wants to optimize ARIS's own harness components based on accumulated experience."
