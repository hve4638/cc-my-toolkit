---
name: lit-comm-review
description: 통신 분야(무선, 네트워킹, 위성/NTN, Wi-Fi, 셀룰러, 빔포밍 등) 특화 문헌 조사. Zotero, Obsidian, 로컬 PDF 우선 검색 후 IEEE Xplore, ScienceDirect, ACM Digital Library, 웹 순서로 탐색. 통신 시스템 연구 관련 논문/서베이가 필요할 때 사용.
