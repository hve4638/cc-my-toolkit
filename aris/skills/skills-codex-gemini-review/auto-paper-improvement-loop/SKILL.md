...
description: "Autonomously improve a generated paper via Gemini review through gemini-review MCP → implement fixes → recompile, for 2 rounds. Use when user says \"논문 수정\", \"improve paper\", \"논문 다듬기 반복\", \"auto improve\", or wants to iteratively polish a generated paper."
---
